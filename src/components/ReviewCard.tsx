...
const ReviewCard = ({ image, name }: Props) => {
  return (
    <div className="max-w-sm rounded-3xl border-[0.5px] border-white/40 bg-white/5 p-5 text-white shadow-lg backdrop-blur-md sm:max-w-full lg:rounded-[45px] lg:p-10">
      <div className="mb-4 flex items-center gap-4">
        ...
        <div>
          <h4 className="text-base text-white lg:text-lg">{name}</h4>
